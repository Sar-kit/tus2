...
HOST=192.168.x.x // Wifi ip if testing on a phone connected to the same wifi. Or the emulator needs a different one i think ( may be wrong).
PORT=1080
...
Build & run the app on a real device
